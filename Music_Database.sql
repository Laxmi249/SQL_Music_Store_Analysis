--Simple....
-- Q1.Who is the senior best employee based on job title? 

Select * from employee
ORDER BY levels desc
limit 1;

-- Q2.Which countaries have the most invoices? 
...
--Moderate.....
-- Q5. Who is the best customers?The customer who has spent the most money will be declared
--the best customer.write a query that return a person who has spent the money most?
...
--Q6.Write a query to return the email ,first_name,last_name,& Genre of all Rock music listener.
...
for each artist. */
/* We make a temporary table using 'Common Table Expression'(CTE) ,which syntax is :
